...
@section('content')
    <div class="bg-white p-3 mb-3">
        ...
        <form class="mt-5 mb-5" action="{{ route('edit') }}" method="post" id="dash-form" enctype="multipart/form-data">
            @csrf
            <div class="row mb-5">
                <div class="col-lg-4 company-logo mb-3">
                    @if(!empty($company->logo))
                        <img src="images/company_images/{{ $company->logo }}">
                    @endif
                </div>
                <div class="col-lg-4">
                    <p>Change logo</p>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 form-group">
                    ...
                    <input name="slogan" value="{{ $company->slogan }}" type="text" class="br-0 p-3 form-control">
                </div>
                <div class="col-lg-4 col-md-6 form-group">
                    <label for="input12">Website</label>
                    <input name="website" value="{{ $company->website }}" type="tel" class="br-0 p-3 form-control">
                </div>
            </div>
