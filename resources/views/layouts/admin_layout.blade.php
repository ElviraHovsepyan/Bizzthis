...
<header class="open-block pl-3 pr-3 font-normal expand-active">
    <div class="row">
        <div class="col-md-6">
            <h3 class="mb-0 text-uppercase font-normal">Hello <span class="text-bold fs-26">Admin</span></h3>
    ...
    <div class="menu expand-active">
        ...
        <ul class="list-unstyled menu-list pt-3 pb-4">
            <li class="mb-3 dashboard">
                <a href="{{ route('adminView') }}" class="trans d-flex justify-content-start text-white align-items-center position-relative" >
                    <span class="menu-icon fa fa-group fs-26"></span>
                    <span class="text ml-2 font-normal text-uppercase">Clients</span>
                </a>
            </li>
